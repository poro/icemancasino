                                ...
                                <div className="table-wrap mb-40 pb-10">
                                    <div className="table-inner">
                                        <div className="table-head">
                                            <Link href="details" className="left-compo">
                                                <span>
                                                    <img src="/img/table/csgo-flag.png" alt="icon" />
                                                </span>
                                                <span>
                                            ...
                                            <ul className="table-body-left">
                                                <li>
                                                    <Link href="details">
                                                        ...
                                                        <span className="icon">
                                                            <img src="/img/table/infernos.png" alt="flag" />
                                                        </span>
                                                    </Link>
                                                </li>
                                                <li>
                                                ...
                                                <li>
                                                    <Link href="details">
                                                        <span className="icon">
                                                            <img src="/img/table/sinners.png" alt="flag" />
                                                        </span>
                                                        <span>Sinners</span>
                                                    </Link>
                                                </li>
                                    ...
                                    <div className="table-inner">
                                        <div className="table-head">
                                            <Link href="details" className="left-compo">
                                                <span>
                                                    <img src="/img/table/esl.png" alt="icon" />
                                                </span>
                                                <span>
                                            ...
                                            <ul className="table-body-left">
                                                <li>
                                                    <Link href="details">
                                                        <span>Cloud9</span>
                                                        <span className="icon">
                                                            <img src="/img/table/cloud.png" alt="flag" />
                                                        </span>
                                                    </Link>
                                                </li>
                                                <li>
                                                ...
                                                <li>
                                                    <Link href="details">
                                                        <span className="icon">
                                                            <img src="/img/table/evil.png" alt="flag" />
                                                        </span>
                                            ...
                                            <ul className="table-body-left">
                                                <li>
                                                    <Link href="details">
                                                        ...
                                                        <span className="icon">
                                                            <img src="/img/table/fireman.png" alt="man" />
                                                        </span>
                                                    </Link>
                                                </li>
                                                <li>
                                                ...
                                                <li>
                                                    <Link href="details">
                                                        <span className="icon">
                                                            <img src="/img/table/furia.png" alt="flat" />
                                                        </span>
                                                        <span>FURIA</span>
                                                    </Link>
                                                </li>
